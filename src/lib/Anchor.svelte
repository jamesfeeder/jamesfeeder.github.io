...
<a
	...
	class="group relative flex items-center gap-1 border-b-2 border-transparent font-medium text-blue-600 transition hover:z-10 hover:border-current hover:bg-slate-50"
	>{label}
